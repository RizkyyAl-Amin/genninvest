...
<style>
    ...
    gap: 20px; /* Optional: Add space between the image and the text */
    }
    ...
    .description {
        max-width: 600px; /* Optional: Set a maximum width for the description text */
        text-align: justify;
    }
...
<section id="artikel" style="margin-top: 10rem" class="artikel d-flex justify-content-center gap-3 p-3">
    <div class="row col-12 col-md-11 col-lg-10">
        <div class="container col-10 col-md-8 col-lg-8" data-aos="fade-up">
            <div class="card mb-3">
                <div class="card-body">
                    <img src="{{ asset('img/uploaded_images/' . $prodi->thumbnail) }}" alt="Thumbnail Image" class="img-thumbnail" style="width: max; height: auto; margin-bottom: 10px;">
                    <h3> {{ $prodi->nama_prodi }} </h5>
                    <p style="text-transform: uppercase;">Apa itu program studi {{ $prodi->nama_prodi }} </p>
                    <div class="flex-container">
                        <img src="{{ asset('img/uploaded_images/' . $prodi->logo) }}" alt="Logo Image" class="img-thumbnail logo">
