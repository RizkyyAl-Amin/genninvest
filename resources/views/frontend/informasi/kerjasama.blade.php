                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-11 col-md-8 order-0 order-md-1">
                            <div class="card-body">
                                ...
                                <p style="text-align:left; font-size:0.9rem; margin-top:1.4rem;" class="card-text">{{ Str::words(strip_tags($kerjasama->content), 25, '...') }}</p>
                                <p style="margin-top:0.9rem;" class="card-text"><small class="text-body-secondary">Updated {{ $kerjasama->created_at->diffForHumans() }} - Oleh {{ $kerjasama->deskripsi }}</small></p>
                            </div>
                        </div>
                    </div>
                </div>
